# MARS
Under the high-dimensional setting, we proposed a secon-order algorithm (MARS) for estimating sparse precision matrices. Note that our algorithm is designed for the cases that the sample dimension p is greater than the sample size n.
...
# Getting started
These instructions will give you a sample example for implementing the package.
