...
RcppExport SEXP _MARS_partgradient(SEXP ZinSEXP, SEXP lambdaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type Zin(ZinSEXP);
    Rcpp::traits::input_parameter< double >::type lambda(lambdaSEXP);
    rcpp_result_gen = Rcpp::wrap(partgradient(Zin, lambda));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_MARS_partgradient", (DL_FUNC) &_MARS_partgradient, 2},
    {NULL, NULL, 0}
};
